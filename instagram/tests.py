...
class ProfileTestClass(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.profile1 = Profile(profile_pic='/static/images/FRANK.jpeg',
                                            bio='Live life',
                                            user=cls.user)
...
class ImageTestClass(TestCase):
    ...
    def setUpTestData(cls):
        # Set up data for the whole TestCase
        cls.user = User.objects.create_user('Happy', 'secret')
        cls.new_profile = Profile(profile_pic='/static/images/FRANK.jpeg',bio='Live life', user=cls.user)
        cls.new_image = Image(my_image='/static/images/FRANK.jpeg', caption='Travel', profile=cls.new_profile)
...
class CommentTestClass(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.new_profile = Profile(profile_pic='/static/images/FRANK.jpeg',
                                     bio='Like it',
                                     user=cls.new_user)
        self.new_profile.save()

        cls.new_image = Image(my_image='/static/images/FRANK.jpeg',
